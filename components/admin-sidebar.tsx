...
const routeLinks: AdminNavLink[] = [
  ...
  { href: "/admin/media", label: "Media Library", description: "Uploaded image assets" },
  { href: "/admin/events", label: "Events", description: "Events, awards, news" },
...
const sectionAnchorsByHref: Record<string, AdminNavAnchor[]> = {
  ...
  "/admin/media": [{ href: "#media-library", label: "Library" }],
};
